...
const name = Yup.string().max(30, 'Too Long').typeError('Must be a string');
const lastname = Yup.string().max(30, 'Too Long').typeError('Must be a string');
const age = Yup.number()
  .integer('Must be an integer')
  .typeError('Must be a number');
const email = Yup.string().email('Invalid email').typeError('Must be a string');
